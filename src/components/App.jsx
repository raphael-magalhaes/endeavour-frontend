...
class App extends Component {
  render() {
    return (
      <MuiThemeProvider theme={this.props.themeType === "light" ? LightTheme : DarkTheme}>
        <div style={{ height: "100vh", overflow: "auto", backgroundColor: this.props.themeType === "light" ? LightTheme.palette.background.default : DarkTheme.palette.background.default }}>
